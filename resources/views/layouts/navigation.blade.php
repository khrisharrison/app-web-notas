<nav x-data="{ open: false }" class="bg-white border-b border-teal-200 shadow-md dark:bg-slate-900 dark:border-transparent">
    ...
    <div class="flex justify-between h-16 items-center">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-teal-600 hover:text-white hover:bg-teal-500 focus:outline-none focus:bg-teal-100 focus:text-teal-700 transition duration-150 ease-in-out dark:text-teal-300 dark:focus:bg-slate-800">
